...
class Organization(db.Model):
    ...
    substitute_requests = db.relationship('SubstituteRequest', backref='organization', lazy=True)
...
class SubstituteRequest(db.Model):
    ...
    organization_id = Column(Integer, ForeignKey('organization.id'), nullable=True)  # Reference to Organization
